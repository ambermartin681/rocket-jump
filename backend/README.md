# Rocket -Jump Admin Dashboard API

Backend API for the Rocket -Jump admin dashboard with protected endpoints for platform management, statistics, and content moderation.

## Features

- Ã°Å¸â€Â Admin authentication with JWT
- Ã°Å¸â€˜Â¥ Role-based access control (RBAC)
- Ã°Å¸â€œÅ  Platform statistics and analytics
- Ã°Å¸Å½Â¯ Token management (flag, soft delete, update)
- Ã°Å¸â€˜Â¤ User management (ban, role changes)
- Ã°Å¸â€œÂ Comprehensive audit logging
- Ã°Å¸â€œÂ¤ Data export functionality
- Ã°Å¸â€â€™ Rate limiting and security headers
...
**Features:**
- Ã¢Å“â€¦ Input validation with express-validator
- Ã¢Å“â€¦ Pagination support
- Ã¢Å“â€¦ Comprehensive error handling
- Ã¢Å“â€¦ OpenAPI documentation
- Ã¢Å“â€¦ Full test coverage
...
**Features:**
- Ã¢Å“â€¦ Server-side caching (5-minute TTL)
- Ã¢Å“â€¦ Rate limiting (100 requests per 15 minutes)
- Ã¢Å“â€¦ Optimized database queries with indexes
- Ã¢Å“â€¦ Comprehensive error handling
...
|----------|------|-------|-------------|
| GET /api/admin/stats | Ã¢ÂÅ’ | Ã¢Å“â€¦ | Ã¢Å“â€¦ |
| GET /api/admin/tokens | Ã¢ÂÅ’ | Ã¢Å“â€¦ | Ã¢Å“â€¦ |
| PATCH /api/admin/tokens/:id | Ã¢ÂÅ’ | Ã¢Å“â€¦ | Ã¢Å“â€¦ |
| DELETE /api/admin/tokens/:id | Ã¢ÂÅ’ | Ã¢ÂÅ’ | Ã¢Å“â€¦ |
| GET /api/admin/users | Ã¢ÂÅ’ | Ã¢Å“â€¦ | Ã¢Å“â€¦ |
| PATCH /api/admin/users/:id | Ã¢ÂÅ’ | Ã¢ÂÅ’ | Ã¢Å“â€¦ |
| GET /api/admin/audit | Ã¢ÂÅ’ | Ã¢Å“â€¦ | Ã¢Å“â€¦ |
...
Ã¢â€â€š   Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ database.ts       # Database operations
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ middleware/
Ã¢â€â€š   Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ auth.ts           # Authentication & RBAC
Ã¢â€â€š   Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ auditLog.ts       # Audit logging
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ routes/
Ã¢â€â€š   Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ admin/
Ã¢â€â€š   Ã¢â€â€š       Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ index.ts      # Route aggregator
Ã¢â€â€š   Ã¢â€â€š       Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ stats.ts      # Statistics endpoints
Ã¢â€â€š   Ã¢â€â€š       Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ tokens.ts     # Token management
Ã¢â€â€š   Ã¢â€â€š       Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ users.ts      # User management
Ã¢â€â€š   Ã¢â€â€š       Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ audit.ts      # Audit logs
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ types/
Ã¢â€â€š   Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ index.ts          # TypeScript types
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ __tests__/
Ã¢â€â€š   Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ admin.test.ts     # Tests
Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ index.ts              # Main application
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ .env.example
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ package.json
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ tsconfig.json
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ vitest.config.ts
```
