#  Stellar Token Deployer (Rocket -Jump)

<div align="center">

![CI](https://github.com/rocket-jump/workflows/CI/badge.svg)
![Security](https://github.com/rocket-jump/workflows/Security%20Scan/badge.svg)
![Coverage](https://codecov.io/gh/rocket-jump/branch/main/graph/badge.svg)
...
**Stellar Token Deployer** (Rocket -Jump) is a decentralized application that enables creators, entrepreneurs, and businesses in emerging markets to deploy custom tokens on the Stellar blockchain without writing a single line of code.
...
graph TD
    ...
    subgraph Blockchain ["Stellar Network (Soroban)"]
        Contract["Token Factory Contract (Rust)"]
        Contract -->|create_token| Token["New Token Instance"]
        Contract -->|mint_tokens| Admin["Admin Operations"]
        Contract -->|set_metadata| Metadata["IPFS URI"]
    end
...
```bash
git clone https://github.com/rocket-jump.git
cd rocket-jump
```
...
```mermaid
graph TD
    Root["rocket-jump/"] --> Contracts["contracts/"]
    Root --> Frontend["frontend/"]
    Root --> Scripts["scripts/"]
    Root --> Kiro[".kiro/"]

    Contracts --> TokenFactory["token-factory/"]
    TokenFactory --> CSrc["src/"]
    CSrc --> Lib["lib.rs"]
    CSrc --> Types["types.rs"]
    CSrc --> Storage["storage.rs"]
    CSrc --> Test["test.rs"]
...
**Q: What is Rocket -Jump?**  
A: Rocket -Jump is a no-code platform for deploying custom tokens on the Stellar blockchain.

**Q: Do I need coding experience?**  
A: No! Rocket -Jump is designed for non-technical users.
